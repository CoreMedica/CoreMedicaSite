            ...
            <div class="hero__inner">
                ...
                <ul class="hero__trust-list" aria-label="Key facts">
                    <li class="hero__trust-item">
                        <svg class="hero__trust-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true" focusable="false">
  ...
  ════════════════════════════════════════════ -->
            ...
            <ul class="service-cards" role="list">
                ...
                <li class="service-card">
                    <div class="service-card__icon-wrap" aria-hidden="true">
                        <svg class="service-card__icon" xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="service-card">
                    <div class="service-card__icon-wrap" aria-hidden="true">
                        <svg class="service-card__icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 48.006 48.006" fill="currentColor"
                            aria-hidden="true" focusable="false">
                ...
                <li class="service-card">
                    <div class="service-card__icon-wrap" aria-hidden="true">
                        <svg class="service-card__icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 31.262 31.262" fill="currentColor"
                            aria-hidden="true" focusable="false">
    ...
    C19.039,10.873,15.631,14.893,15.631,14.893z" />
                ...
                <li class="service-card">
                    <div class="service-card__icon-wrap" aria-hidden="true">
                        <svg class="service-card__icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512.001 512.001" fill="currentColor"
                            aria-hidden="true" focusable="false">
                ...
                <div class="location-band__details">
                    <div class="location-band__clinic">
                        ...
                        <ul class="location-band__meta">
                         ...
                         2 2 0 0 1 3.6 1.23h3a2 2 0 0 1 2 1.72c.127.96.361
                         1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.88a16 16 0 0 0
                         6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573
                         2.81.7A2 2 0 0 1 21.73 16.92z" />
                                </svg>
