    ...
    <div class="container">
        <div class="footer-upper">
            ...
            <div class="footer-brand">
                <a href="/" aria-label="CoreMedica Wellness Group — Home">
                    <img src="/assets/images/coremedica_new_logo_text.webp"
                        alt="CoreMedica Wellness Group"
                        width="180"
                        height="40">
                </a>
                <p>Professional ear care and wellness services in Southampton and Portsmouth.</p>
            </div>
    ...
    <div class="container">
        <div class="footer-lower">
            <p class="footer-legal">
                &copy; <?php echo date('Y'); ?> CoreMedica Wellness Group Ltd. All rights reserved.
                Registered in England &amp; Wales.
            </p>
            <p class="footer-legal">
                Southampton &middot; Portsmouth
            </p>
        </div>
    </div>
